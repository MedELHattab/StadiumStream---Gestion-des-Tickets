...
<!--Form seesion-->
            <div class="grid grid-cols-2 gap-4 place-content-around py-8">
                   ...
                   <div class="flex flex-col items-center pb-10  ">
                    <img class="rounded-full w-48 h-64" name="Image" src="<?=$image?>"style="width:150px">
                    ...
                    <div class="mt-6">
           <form class="max-w-sm mx-auto"action="/EditProfil/editProfil" enctype="multipart/form-data">
            <div class="mb-8"><h1 >Edit Profil</h1></div>
             ...
             <div class="mb-5">
             <label for="Image" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Old password:</label>
