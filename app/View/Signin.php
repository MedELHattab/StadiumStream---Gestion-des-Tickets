...
<body>
        ...
        <nav class="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
            <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                <a href="https://flowbite.com" class="flex items-center">
                    <img src="../../public/assets/images/Asset_6.svg" class="mr-3 h-6 sm:h-9"
                        alt="StadiumStream Logo" />
                </a>
    ...
    <div class="border-black py-8 px-4 mb-20 mt-4 mx-[7em] border">
        ...
        <form class="w-full md:w-6/12 xl:w-4/12" method="post" action="/signin">
                ...
                <div class="flex items-center justify-center"><button class="bg-[#004634]  text-white font-bold py-2 px-4 border rounded" style="background-color: #004634;">
                    Log in 
                </button></div>
            </form>
        </div>
