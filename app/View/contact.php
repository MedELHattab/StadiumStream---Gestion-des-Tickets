...
<body>
        ...
        <div class="hero_section flex flex-col mx-[7em] gap-x-3">
    <div class="p-4" style="border-left: 2px solid #004634; color: #004634;" >Contact <span style="color: #FF6E01;">Us</span></div>
        ...
        <div class="flex justify-center gap-4 mt-8">
            <form class="w-full md:w-7/12 xl:w-5/12" data-gtm-form-interact-id="0">
                <div>
                    ...
                    <div>
                        <div class="mb-6 relative" type="tel"><label for="message"
                            class="opacity-40 org-text-primary sr-only">Message</label>
