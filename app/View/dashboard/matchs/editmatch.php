        ...
        <div class="bg-white dark:bg-gray-800 border border-[#D9D9DE] dark:border-gray-700 rounded-xl p-8 mb-12">
            ...
            <section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5 antialiased">
                <h1 class="text-2xl font-bold text-center mb-6 text-gray-900 dark:text-white">
                    Edit <span class="text-orange-500">Match</span>
                </h1>
                        ...
                        <div class="overflow-x-auto">
                            ...
                            <form action="../edit/<?= $id ?>" method="POST">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="datetime-local" id="dateHeure" name="dateHeure" class="mt-1 p-2 border rounded w-full" value="<?= date('Y-m-d\TH:i', strtotime($match['DateHeure'])) ?>">
                                </div>
                                <input type="text" hidden name="MatchID" value="<?= $id ?>">
