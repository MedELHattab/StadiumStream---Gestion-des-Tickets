        ...
        <div class="bg-white dark:bg-gray-800 border border-[#D9D9DE] dark:border-gray-700 rounded-xl p-8 mb-12">
            ...
            <section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5 antialiased">
                <h1 class="text-2xl font-bold text-center mb-6 text-gray-900 dark:text-white">
                    Table <span class="text-orange-500">Match</span>
                </h1>
                            ...
                            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                    <tr>
                                        ...
                                        <th scope="col" class="px-4 py-4"> Equipe Domicile</th>
                                        <th scope="col" class="px-4 py-4"> Equipe Exterieur</th>
                                        <th scope="col" class="px-4 py-3">Stadium</th>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        ...
                                        <tr class="border-b dark:border-gray-700">
                                            ...
                                            <td class="px-4 py-3  text-center"><?= $match['EquipeDomicile'] ?></td>
                                            <td class="px-4 py-3 text-center"><?= $match['EquipeExterieur'] ?> </td>
                                            <td class="px-4 py-3 text-center"><?= $match['NomStade'] ?> </td>
                                            <td class="px-4 py-3 text-center"><?= $match['DateHeure'] ?> </td>

                                            <td class="px-4 py-3 text-center  ">

                                                <button id="<?= $match['MatchID'] ?>-button" data-dropdown-toggle="<?= $match['MatchID'] ?>" class=" inline-flex items-center text-sm font-medium hover:bg-gray-100 dark:hover:bg-gray-700 p-1.5 dark:hover-bg-gray-800 text-center text-gray-500 hover:text-gray-800 rounded-lg focus:outline-none dark:text-gray-400 dark:hover:text-gray-100" type="button">
                                                    <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M6 10a2 2 0 11-4 0 2 2 0 014 0zM12 10a2 2 0 11-4 0 2 2 0 014 0zM16 12a2 2 0 100-4 2 2 0 000 4z" />
                                                    </svg>
                                                </button>

                                                <div id="<?= $match['MatchID'] ?>" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                                    <ul class="py-1 text-sm" aria-labelledby="<?= $match['MatchID'] ?>-button">
                                                        <li>


                                                            <a href="editmatch/read/<?= $match['MatchID'] ?>">
                                                        ...
                                                        <li>
                                                            <a href="deletematch/delete/<?= $match['MatchID'] ?>">
