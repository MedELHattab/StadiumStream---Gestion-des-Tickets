...
<form class=" bg-orange-400 py-8  max-w-sm mx-auto" action="createStadium" method='post'>
<div class="mb-8"><h1 >Add</h1></div>
          ...
          <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-orange-600 dark:hover:bg-orange-700 dark:focus:ring-orange-800">Add stade+</button>
         </div>
        </form>
</div>
