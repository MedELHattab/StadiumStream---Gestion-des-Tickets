...
<section class="text-gray-600 body-font">
      ...
      >
        <img
          ...
          <img src="public/assets/images/AFCON-2022.jpg" alt="">
        ...
        <div class="px-4 py-4">
            <div class="flex items-center">
                <a href="#" class="flex items-center">
                    <img src="public/assets/images/icons8-date-50.png" alt="" class="w-6 h-6 mr-2">
                  
                    <h5 class="text-lg font-semibold tracking-tight text-gray-900 dark:text-white">13 Jan, - 11 Feb, Sun</h5>
                </a>
            </div>
            <div class="mt-2">
                Billets à partir de:
